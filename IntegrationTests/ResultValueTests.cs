...
namespace IntegrationTests
{
	...
	public class ResultValueTests
	{
		...
		{
			var result = new MsSqlAutoMapper().AddCommandName("dbo.GetInts").ExecuteWithValueResult<int>();
		...
		{
			var results = new MsSqlAutoMapper().AddCommandName("dbo.GetInts").ExecuteWithValueResults<int?>();
		...
		public void TestExecuteWithValueResultsInt()
		{
			try
			{
				new MsSqlAutoMapper().AddCommandName("dbo.GetInts").ExecuteWithValueResults<int>();
			}
		...
		{
			var result = new MsSqlAutoMapper().AddCommandName("dbo.GetStrings").ExecuteWithValueResult<string>();
		...
		{
			var results = new MsSqlAutoMapper().AddCommandName("dbo.GetStrings").ExecuteWithValueResults<string>();
		...
		{
			var result = new MsSqlAutoMapper().AddCommandName("dbo.GetBools").ExecuteWithValueResult<bool>();
		...
		{
			var results = new MsSqlAutoMapper().AddCommandName("dbo.GetBools").ExecuteWithValueResults<bool?>();
		...
		public void TestExecuteWithValueResultsBool()
		{
			try
			{
				new MsSqlAutoMapper().AddCommandName("dbo.GetBools").ExecuteWithValueResults<bool>();
			}
			catch (AggregateException ex)
			{
				Assert.AreEqual(1, ex.InnerExceptions.Count);
		...
		{
			var result = new MsSqlAutoMapper().AddCommandName("dbo.GetDateTimes").ExecuteWithValueResult<DateTime>();
		...
		{
			var results = new MsSqlAutoMapper().AddCommandName("dbo.GetDateTimes").ExecuteWithValueResults<DateTime?>();
		...
		public void TestExecuteWithValueResultsDateTime()
		{
			try
			{
				new MsSqlAutoMapper().AddCommandName("dbo.GetDateTimes").ExecuteWithValueResults<DateTime>();
			}
			catch (AggregateException ex)
			{
				Assert.AreEqual(1, ex.InnerExceptions.Count);
		...
		{
			var result = new MsSqlAutoMapper().AddCommandName("dbo.GetGuids").ExecuteWithValueResult<Guid>();
		...
		{
			var results = new MsSqlAutoMapper().AddCommandName("dbo.GetGuids").ExecuteWithValueResults<Guid?>();
			Assert.AreEqual(4, results.Count());
		...
		public void TestExecuteWithValueResultsGuid()
		{
			try
			{
				new MsSqlAutoMapper().AddCommandName("dbo.GetGuids").ExecuteWithValueResults<Guid>();
			}
			catch (AggregateException ex)
			{
				Assert.AreEqual(1, ex.InnerExceptions.Count);
